...
Yii::import('luckywave.widgets.grid.CGridColumn');
...
class CButtonColumn extends CGridColumn
{
	...
	protected function initDefaultButtons()
	{
		if($this->viewButtonLabel===null)
			$this->viewButtonLabel=Yii::t('luckywave','View');
		if($this->updateButtonLabel===null)
			$this->updateButtonLabel=Yii::t('luckywave','Update');
		if($this->deleteButtonLabel===null)
			$this->deleteButtonLabel=Yii::t('luckywave','Delete');
		if($this->viewButtonImageUrl===null)
			$this->viewButtonImageUrl='<div class="row"><i class="fa fa-search fa-lg">檢視</i></div>';
		if($this->updateButtonImageUrl===null)
			$this->updateButtonImageUrl='<div class="row"><i class="fa fa-pencil-square-o fa-lg">更新</i></div>';
		if($this->deleteButtonImageUrl===null)
			$this->deleteButtonImageUrl='<div class="row"><i class="fa fa-times fa-lg">刪除</i></div>';
		if($this->deleteConfirmation===null)
			$this->deleteConfirmation=Yii::t('luckywave','你確定要刪除此項目嗎?');
...
EOD;
	...
	protected function renderButton($id,$button,$row,$data)
	{
		...
		if(isset($button['imageUrl']) && is_string($button['imageUrl']))
			echo CHtml::link($button['imageUrl'],$url,$options)."<br/>";
		else
