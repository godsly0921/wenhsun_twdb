...
ALTER TABLE `wenhsun`.`personal_calendar`
ADD COLUMN `public` VARCHAR(7) NOT NULL DEFAULT 'PRIVATE' AFTER `canceler_type`,
CHANGE COLUMN `id` `id` INT(11) NOT NULL COMMENT 'ID' ;

ALTER TABLE `wenhsun`.`personal_calendar`
CHANGE COLUMN `public` `content` VARCHAR(32) NULL ;

ALTER TABLE `wenhsun`.`personal_calendar`
CHANGE COLUMN `empolyee_id` `employee_id` VARCHAR(32) NOT NULL COMMENT '打工者ID' ;

ALTER TABLE `wenhsun`.`personal_calendar`
CHANGE COLUMN `public` `public` VARCHAR(7) NULL DEFAULT NULL ;
