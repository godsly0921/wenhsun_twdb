...
INSERT INTO `coupon` (`coupon_id`, `coupon_name`, `coupon_code`, `coupon_pic`, `start_time`, `end_time`, `status`, `create_time`, `create_account_id`, `update_time`, `update_account_id`) VALUES
(1, 'test', '1234', 10, '2019-05-13 00:00:00', '2019-05-16 23:59:59', 1, '2019-05-14 00:13:36', 1, '2019-05-14 00:33:36', 1);
...
--
ALTER TABLE `coupon`
  MODIFY `coupon_id` int(12) NOT NULL AUTO_INCREMENT COMMENT '流水號', AUTO_INCREMENT=3;
COMMIT;
