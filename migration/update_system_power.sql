...
--
-- Host: localhost    Database: wenhsun
-- ------------------------------------------------------
...
CREATE TABLE `power` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=228 DEFAULT CHARSET=utf8 COMMENT='權限功能';
...
INSERT INTO `power` VALUES (36,33,'功能列表','power/index',1,0,1),(37,34,'功能新增','power/create',1,1,0),(40,120,'角色列表','group/index',1,4,1),(41,13,'角色新增','group/create',1,5,0),(42,14,'角色修改','group/update',1,6,0),(43,15,'角色刪除','group/delete',1,7,0),(44,16,'系統管理帳號列表','account/index',1,8,1),(45,17,'系統管理帳號新增','account/create',1,9,0),(46,19,'系統管理帳號修改','account/update',1,10,0),(47,20,'系統管理帳號刪除','account/delete',1,11,0),(48,21,'系統列表','system/index',1,12,1),(49,22,'系統新增','system/create',1,13,0),(50,23,'系統修改','system/update',1,14,0),(116,24,'系統刪除','system/delete',1,15,0),(118,118,'功能修改','power/update',1,2,0),(119,119,'功能刪除','power/delete',1,3,0),(120,27,'員工列表','member/list',2,0,1),(126,32,'公布欄消息列表','news/index',3,0,1),(127,35,'公布欄消息更新','news/update',3,1,0),(128,36,'公布欄消息刪除','news/delete',3,3,0),(131,38,'分機分配表','employee/extensions',2,0,1),(140,47,'作家列表','author',4,0,1),(141,48,'特殊狀況管理新增','specialcase/create',4,0,0),(142,49,'特殊狀況管理刪除','specialcase/delete',4,0,0),(143,50,'特殊狀況管理修改','specialcase/update',4,0,0),(152,59,'員工新增','member/create',2,0,0),(153,60,'員工資料修改','member/update',2,0,0),(154,61,'員工刪除','member/delete',2,0,0),(156,63,'員工座位列表','employee/seats',2,0,1),(159,66,'薪資列表','calculationfee/index',5,0,1),(174,81,'消息公布','news/list',3,4,1),(187,94,'每日出勤記錄明細表','doorrec/report',2,5,1),(189,96,'每日出缺勤一覽表','doorcount/report',2,6,1),(190,97,'假日設定列表','record/abnormal_list',2,0,1),(191,98,'出勤異常列表','record/get_abnormal_list',2,0,0),(202,109,'公文列表','door/list',6,0,1),(203,110,'門禁計費方式設定修改','door/update',6,0,0),(204,111,'門禁計費方式設定刪除','door/delete',6,0,0),(205,112,'門禁計費方式設定新增','door/create',6,0,0),(211,121,'公布欄消息新增','news/create',3,0,0),(219,128,'門禁時段設定修改','doorpermission/time_group_update',2,7,0);
...
-- Dump completed on 2019-04-21 22:25:33
