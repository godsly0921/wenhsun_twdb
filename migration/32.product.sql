...
INSERT INTO `product` (`product_id`, `product_name`, `coupon_id`, `pic_point`, `pic_number`, `product_type`, `price`, `status`, `create_time`, `create_account_id`, `update_time`, `update_account_id`) VALUES
(1, '點數 ( 50.00 點 )', 1, 50.00, 0, 1, 500, 1, '2019-05-06 00:39:42', 1, '2019-05-14 00:44:11', 1),
(3, '自由載 90 天 ( 50 張 )', 0, 0.00, 50, 3, 5000, 1, '2019-05-06 01:15:38', 1, NULL, NULL);
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(12) NOT NULL AUTO_INCREMENT COMMENT '流水號', AUTO_INCREMENT=4;
COMMIT;
