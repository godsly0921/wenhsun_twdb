			...
			if(!$check_commmon['result']){
				...
				if(isset($params['body']['keyword'])){
		        	...
		        	if(empty($params['body']['keyword'])){
						$filter['$and'] = array(array('photo_limit'=>array( '$in' => array('1','3'))),array('copyright' => '1'),array('publish' => '1'));
						//array('photo_limit'=>array( '$in' => array('1','3'));//通通開放 僅限API使用
		        	}else{
						$filter['$and'] = array(array('photo_limit'=>array( '$in' => array('1','3'))),array('copyright' => '1'),array('publish' => '1'),array('keyword'=>array( '$in' => $explode_keyword )));
