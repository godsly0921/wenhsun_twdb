...
class BooksizeController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('BookSize');
	...
	{
		$model=new BookSize('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['BookSize']))
			$model->attributes=$_GET['BookSize'];
	 ...
	 * @return BookSize the loaded model
	 ...
	 * @param BookSize $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='book-size-form')
		{
