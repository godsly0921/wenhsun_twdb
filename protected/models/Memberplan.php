...
class Memberplan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('order_item_id, amount, remain_amount, status', 'required'),
			array('order_item_id, amount, remain_amount, status', 'numerical', 'integerOnly'=>true),
			array('date_start, date_end', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('member_plan_id, order_item_id, date_start, date_end, amount, remain_amount, status', 'safe', 'on'=>'search'),
		);
	}
