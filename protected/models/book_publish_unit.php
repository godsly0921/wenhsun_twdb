...
/**
 * This is the model class for table "book_publish_unit".
 *
 * The followings are the available columns in table 'book_publish_unit':
 * @property integer $publish_unit_id
 ...
 */
class book_publish_unit extends CActiveRecord
{
	/**
	...
	public function search()
	{
		...
		$criteria->compare('publish_unit_id',$this->publish_unit_id);
	 ...
	 * @return book_publish_unit the static model class
	 */
