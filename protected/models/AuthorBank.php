...
class AuthorBank extends CActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            ['bank_code', 'length', 'min' => 1, 'max' => 50, 'tooLong' => "銀行代碼最多50個字元"],
            ['branch_name', 'length', 'min' => 1, 'max' => 50, 'tooLong' => "分行名稱最多50個字元"],
            ['branch_code', 'length', 'min' => 1, 'max' => 50, 'tooLong' => "分行代碼最多50個字元"],
            ['bank_account', 'length', 'min' => 1, 'max' => 50, 'tooLong' => "帳號最多50個字元"],
