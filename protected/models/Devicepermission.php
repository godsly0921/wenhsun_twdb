...
/**
 * This is the model class for table "device_permission".
 *
 * The followings are the available columns in table 'device_permission':
 * @property integer $id
 ...
 */
class Devicepermission extends CActiveRecord
{
	/**
	 ...
	 * @return Devicepermission the static model class
	 */
