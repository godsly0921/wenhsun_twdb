...
{
    public function findSpecialcase()
    {
        $result = Specialcase::model()->findAll();
        return $result;
    }
     ...
     */
    public function updateSpecialcase(array $inputs)
    {
        $model = Specialcase::model()->findByPk($inputs["id"]);
