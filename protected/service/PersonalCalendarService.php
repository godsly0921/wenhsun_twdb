...
{
    public function findPersonalCalendarDayAll($start_time, $end_time)
    {
    ...
    public function findPersonalCalendarDayAllWithoutCancel($start_time, $end_time)
    {
        $result = PersonalCalendar::model()->findAll([
    ...
    public function findPersonalCalendarDayAllByUserID($start_time, $end_time,$user_id,$id)
    {
        $result = PersonalCalendar::model()->findAll([
    ...
    public function findPersonalCalendarByUserIDWithTime($user_id,$startime,$endtime)
    {
        $result = PersonalCalendar::model()->findAll([
    ...
    public function findPersonalCalendarByUserTimeAndDeviceId($device_id,$user_time,$use_id)
    {
    ...
    public function findPersonalCalendarDayAllForStation($station_id,$datetime)
    {
        $res = Yii::app()->db->createCommand()
            ->select('d.*, r.*')
            ->from('device d')
    ...
    public function findPersonalCalendarCancelDayAll($start_time, $end_time)
    {
        $result = PersonalCalendar::model()->findAll([
            'condition' => 'start_time>=:start_time and end_time<=:end_time and status=:status',
            'params' => [
    ...
    public function findPersonalCalendarDeviceIDAll($device_id,$start_time, $end_time)
    {
        $result = PersonalCalendar::model()->findAll([
    ...
    public function findPersonalCalendarCancelAndConditionDayAll($inputs)
    {
        ...
        $datas = PersonalCalendar::model()->findAll($criteria);
    ...
    public function findPersonalCalendarDayAllAndDevice($empolyee_id,$day)
    {
        $criteria = new CDbCriteria();
        $criteria->select = '*';
    ...
    public function findPersonalCalendarAll($employee_id)
    {
        $result = PersonalCalendar::model()->findAll([
            'condition' => 'employee_id=:employee_id and status=:status',
            'params' => [
    ...
    public function findPersonalCalendar()
    {
        $result = PersonalCalendar::model()->findAll();
        return $result;
    }
    ...
    public function findPersonalCalendarByStatusAndDate($status,$date)
    {
        $result = PersonalCalendar::model()->findAll([
     ...
     */
    public function updatePersonalCalendar(array $inputs)
    {
        $model = PersonalCalendar::model()->findByPk($inputs["id"]);
    ...
    // 轉換預約狀態
    public function editPersonalCalendarStatus( $id , $status ){

        $PersonalCalendar           = PersonalCalendar::model()->findByPk( $id );
        $PersonalCalendar->status   = $status;
        $PersonalCalendar->canceler = $_SESSION['uid'];
        $PersonalCalendar->canceler_type= Yii::app()->session['personal'];
        if( $PersonalCalendar->save() ){
    ...
    public function findPersonalCalendarById($id)
    {
        $result = PersonalCalendar::model()->findAll([
            'condition' => 'id=:id',
            'params' => [
