...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form name="group_form" class="form-horizontal" action="<?php echo Yii::app()->createUrl('coupon/update');?>/<?= $coupon_data->coupon_id ?>" method="post">
            <?php CsrfProtector::genHiddenField(); ?>
            <div class="form-group">
                <label for="adv_id" class="col-sm-2 control-label">優惠名稱:</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="coupon_name" name="coupon_name" placeholder="請輸入優惠名稱" value="<?=$coupon_data->coupon_name?>" required>
                </div>
            </div>
            <div class="form-group">
                <label for="adv_id" class="col-sm-2 control-label">折扣代號:</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="coupon_code" name="coupon_code" placeholder="請輸入折扣代號" value="<?=$coupon_data->coupon_code?>" required>
                </div>
            </div>
            <div class="form-group">
                <label for="adv_id" class="col-sm-2 control-label">張數:</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="coupon_pic" name="coupon_pic" placeholder="請輸入張數" value="<?=$coupon_data->coupon_pic?>" required>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control has-feedback-left datetime" name="start_time" placeholder="開始時間" aria-describedby="inputSuccess2Status2" value="<?=$coupon_data->start_time?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control has-feedback-left datetime" name="end_time" placeholder="結束時間" aria-describedby="inputSuccess2Status2" value="<?=$coupon_data->end_time?>">
                    <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                    <span id="inputSuccess2Status2" class="sr-only">(success)</span>
                </div>
            </div>      
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select class="form-control" name="status" required>                      
                        <option value="1" <?=$coupon_data->status == 1 ? 'selected':''?>>是</option>
                        <option value="0" <?=$coupon_data->status == 0 ? 'selected':''?>>否</option>
                    </select>
                </div>
            </div> 
            <div class="form-group">
