    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading col-md-12">
                    ...
                    <div class='col-md-2'> 
                    <form class="form-horizontal" action="<?php echo Yii::app()->createUrl('userbill/allstudentexcel');?>" method="post">
                    ...
                    <div class='col-md-2'>
                    <a href="<?=Yii::app()->createUrl('userbill/allstudenprinter');?>"  target="_blank">     
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="row text-center">
                        <form action="<?php echo Yii::app() -> createUrl('Userbill/allstudentbillpaydo/')?>"  method="POST" onsubmit="return confirm('提醒您,進行此動作後帳單紀錄將會付清\n請確實核對所接收之款項');">

                            <input type="hidden" name="allMember" value="<?=$allMemberStr?>">
