    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo Yii::app() -> createUrl('Userbill/mybill/').'/'.$mid;?>"  method="POST" >
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <!-- 帳單修改申請 -->
                <div class='row'>
                    <span class="label label-primary">帳單修改申請</span>
                    
                    <form action="<?=Yii::app()->createUrl('userbill/change_bill_apply')?>" method="POST">
                        
                        <?php CsrfProtector::genHiddenField(); ?>
                        <div class="form-group _np">
                        <input type="hidden" name="start" value="<?=$start?>">
                        <input type="hidden" name="mid" value="<?=$mid?>">

                        <textarea class="form-control" rows="3" placeholder="請於此表單填寫,申請調整帳單源由,如:離開時忘記刷,並清楚填寫時間點以及機台以利作業程序" name='des'></textarea>
                        </div>

                        <div class="form-group _np">
                            <div class="col-sm-offset-0 col-sm-10 text-center">
                                <button type="submit" class="btn btn-default">送出申請</button>
                            </div>
                        </div>
                    </form>
                </div>
