                    ...
                    <div class="x_content">
                        ...
                        <form id="form" method="post" action="<?= Yii::app()->createUrl('/employee/management/update');?>" data-parsley-validate class="form-horizontal form-label-left" novalidate>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" id="department" name="department">
                                        ...
                                        <?php foreach ($departments as $department):?>
                                            <option value="<?=$department?>" <?php if($department === $data->department):?>selected<?php endif;?>><?=$department?></option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="position" name="position" value="<?=$data->position?>" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
