<div class="panel panel-default" style="width=100%; overflow-y:scroll;">
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" id="title_<?=$i?>" size="200", maxlength="200" name="BookAuthorEvent[title][]" required="required" class="form-control" value="<?=$model_author_event->title?>">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<textarea id="description_<?=$i?>" rows="6" cols="50" class="form-control" name="BookAuthorEvent[description][]"></textarea>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<select class="form-control image_link" id="image_link_<?=$i?>" name="BookAuthorEvent[image_link][]" required="required">
	                ...
	                ?>
	                    <option value="<?=$value['single_id']?>" data-tokens="<?=implode(",",$data_tokens)?>" data-content="<img class='data_thumbnail lazyload' width='100' height='auto' data-src='<?=DOMAIN."image_storage/P/".$value['single_id']?>.jpg' data-original='<?=DOMAIN."image_storage/P/".$value['single_id']?>.jpg'></img> <?=$value['single_id']?>" <?=$model_author_event->image_link==$value['single_id']?'selected':''?> <?=$model_author_event->image_link==$value['single_id']?'selected':''?>><?=$value['single_id']?></option>
	                <?php }?>
	            </select>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" id="year_<?=$i?>" size="4", maxlength="4" name="BookAuthorEvent[year][]" required="required" data-date-format="yyyy" class="form-control datepicker" value="<?=$model_author_event->year?>" placeholder="年表-年">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" id="month_<?=$i?>" size="2", maxlength="2" name="BookAuthorEvent[month][]" data-date-format="mm" class="form-control datepicker" value="<?=$model_author_event->month?>" placeholder="年表-月">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" id="day_<?=$i?>" size="2", maxlength="2" name="BookAuthorEvent[day][]" data-date-format="dd" class="form-control datepicker" value="<?=$model_author_event->day?>" placeholder="年表-日">
			</div>
