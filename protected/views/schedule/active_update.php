    ...
    <div class="panel-body">
        <form name="group_form" class="form-horizontal" action="<?php echo Yii::app()->createUrl('schedule/active_update');?>/<?=$active->active_id?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="active_name" name="active_name" required placeholder="請輸入標題" value="<?=$active->active_name?>">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 control-label">活動時間:</label>
                <div class="col-sm-10">
                    <input id="active_date" type="text" class="form-control active_date" name="active_date" value="<?=$active->active_date?>" />
