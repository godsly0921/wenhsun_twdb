        ...
        <form name="group_form" class="form-horizontal" action="<?php echo Yii::app()->createUrl('schedule/shift_create');?>" method="post" enctype="multipart/form-data">
                ...
                <div class="col-sm-10">
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="store_id" checked value="1">一般館舍
                        </label>
                    </div>
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="store_id" value="2">茶館
                        </label>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="in_out" checked value="0">不分
                        </label>
                    </div>
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="in_out" value="1">內場
                        </label>
                    </div>
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="in_out" value="2">外場
                        </label>
                    </div>
                </div>
            </div>     
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="class" checked value="A">A
                        </label>
                    </div>
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="class" value="B">B
                        </label>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="is_special" checked value="0">否
                        </label>
                    </div>
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="is_special" value="1">是
                        </label>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control has-feedback-left datetime_start" id="date_start" name="start_time" required placeholder="請輸入上班時間" value="" aria-describedby="inputSuccess2Status2">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control has-feedback-left datetime_end" id="date_end" name="end_time" required placeholder="請輸入下班時間" value="" aria-describedby="inputSuccess2Status2">
                    <span class="glyphicon glyphicon-time form-control-feedback left" aria-hidden="true"></span>
                    <span id="inputSuccess2Status2" class="sr-only">(success)</span>
                </div>
            </div>
