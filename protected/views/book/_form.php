...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<select class="form-control selectpicker"  id="single_id" name="single_id" data-live-search="true">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<select multiple class="form-control selectpicker" title="請選擇" id="sub_author_id" name="sub_author_id" data-live-search="true">
                <?php foreach ($FK_data['book_author'] as $value){?>
                    <option value="<?=$value['author_id']?>" data-tokens="<?=$value['author_id'] . '-' . $value['name']?>" <?=$model->sub_author_id==$value['author_id']?'selected':''?>><?=$value['author_id'] . '-' . $value['name']?></option>
                <?php }?>
            </select>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<select class="form-control selectpicker" id="publish_place" name="publish_place" data-live-search="true">
				<option value="">請選擇</option>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<select class="form-control selectpicker" id="publish_organization" name="publish_organization" data-live-search="true">
				<option value="">請選擇</option>
		...
		<div class="col-sm-8">
			<select class="form-control selectpicker" id="series" name="series" data-live-search="true">
                ...
                <?php foreach ($FK_data['book_series'] as $value){?>
                    <option value="<?=$value['book_series_id']?>" data-tokens="<?=$value['book_series_id'] . '-' . $value['name']?>" <?=$model->book_size==$value['book_series_id']?'selected':''?>><?=$value['book_series_id'] . '-' . $value['name']?></option>
                <?php }?>
            </select>
		</div>
