...
$('.search-form form').submit(function(){
	$('#book-sub-category-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Book Sub Categories 管理</h1>
<?php
	foreach ($session_jsons as $jsons) {
		if ($jsons["power_controller"] == Yii::app()->controller->id . "/create"){
			echo "<a href='".Yii::app()->createUrl(Yii::app()->controller->id."/create")."' class='btn btn-default btn-right'>新增Book Sub Categories</a>";
		}
	}
