...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'isroot', array('class'=>'col-sm-3 control-label')); ?>
		<div class="col-sm-8">
			<?php echo $form->textField($model,'isroot', array('class'=>'form-control')); ?>
		</div>
		<?php echo $form->error($model,'isroot'); ?>
	</div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'parents', array('class'=>'col-sm-3 control-label')); ?>
		<div class="col-sm-8">
