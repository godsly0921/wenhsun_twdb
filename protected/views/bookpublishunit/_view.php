...
/* @var $data BookPublishUnit */
?>

<div class="view">

	<b><?php echo CHtml::encode($data->getAttributeLabel('publish_unit_id')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->publish_unit_id), array('view', 'id'=>$data->publish_unit_id)); ?>
	<br />
