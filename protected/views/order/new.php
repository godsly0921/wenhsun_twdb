...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form name="group_form" class="form-horizontal" action="<?php echo Yii::app()->createUrl('product/new');?>" method="post">
            <?php CsrfProtector::genHiddenField(); ?>
            <div class="form-group">
                <label for="adv_id" class="col-sm-2 control-label">產品名稱:</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="product_name" name="product_name" placeholder="請輸入產品名稱" value="" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="pic_point" name="pic_point" placeholder="請輸入點數" value="" required>
                </div>
            </div>    
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <div class="radio">
                        <label>
                          <input type="radio" class="flat product_type" checked name="product_type" value="1"> 點數
                        </label>
                        <label>
                          <input type="radio" class="flat product_type" name="product_type" value="2"> 自由載 30 天
                        </label>
                        <label>
                          <input type="radio" class="flat product_type" name="product_type" value="3"> 自由載 90 天
                        </label>
                        <label>
                          <input type="radio" class="flat product_type" name="product_type" value="4"> 自由載 360 天
                        </label>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="pic_number" name="pic_number" placeholder="請輸入張數" value="0" readonly="true" required>
                </div>
            </div>
            <div class="form-group">
                <label for="adv_id" class="col-sm-2 control-label">產品售價:</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="price" name="price" placeholder="請輸入產品售價" value="" required>
                </div>
            </div>         
            <div class="form-group">
