<div class="container">
    ...
    <hr>
    <a href="#" class="text-center register"><h6>還不是會員?立即註冊</h6></a>
    <form role="form" class="col-lg-8 mx-auto mt-5" action="<?php echo Yii::app()->createUrl('site/login'); ?>" method="post" accept-charset="utf-8">
        <div class="form-group row">
            <label for="account" class="col-sm-2 col-form-label">帳　　　號</label>
            <div class="col-sm-8">
        ...
        <div class="form-group row">
            <label for="password" class="col-sm-2 col-form-label">密　　　碼</label>
            <div class="col-sm-8">
        ...
        <div class="form-group row">
            ...
            <a href="#" class="col-sm-8 forget"><h6>忘記密碼?</h6></a>
        </div>
        <div class="form-group col-lg-12 text-center">
            <button type="submit" class="btn col-lg-3 login_button btn-lg">登入</button>
        </div>
    </form>
    <hr class="mt-5">
    <div class="text-center">
